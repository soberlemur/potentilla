...
/**
 * Here we extend the Antlr-generated parser to provide implementations of the supplied callback hooks in order to transform the AST into a more workable object
 * model.
 *
...
public class ExtendedCatalogParser extends CatalogParser {
     ...
     * @throws IOException
     */
    public ExtendedCatalogParser(Catalog catalog, File file) throws IOException {
    ...
    protected void handleMsgctxt(AST msgctxt) {
        currentMessage.setMsgContext(extractText(msgctxt));
    }
